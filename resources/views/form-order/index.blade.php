                                                ...
                                                <td class="px-4 py-3 border text-sm font-medium whitespace-nowrap">
                                                    <div class="flex space-x-2 justify-start">
                                                        ...
                                                        <a href="{{ route('form-order.pdf', $order->id) }}" 
                                                           target="_blank"
                                                           class="{{ $order->ttd_nama_terang ? 'text-green-700 hover:text-green-900 bg-green-100 hover:bg-green-200' : 'text-gray-700 hover:text-gray-900 bg-gray-100 hover:bg-gray-200' }} px-3 py-1 rounded text-xs font-medium transition-colors">
                                                            PDF
                                                        </a>
