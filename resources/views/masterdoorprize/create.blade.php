                    ...
                    <form action="{{ route('masterdoorprize.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_doorprize" id="nama_doorprize" value="{{ old('nama_doorprize') }}" 
                                   ...
                                   placeholder="Masukkan nama doorprize">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="jumlah_doorprize" id="jumlah_doorprize" value="{{ old('jumlah_doorprize') }}" min="0"
