                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="text-center mb-6">
                        <div class="flex items-center justify-center mb-4">
                            <div>
                                <h1 class="text-3xl font-bold text-gray-900">🏆 List Pemenang Doorprize Kehadiran</h1>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="relative">
                                <input 
                                    type="text" 
                                    id="searchInput" 
                                    placeholder="Cari toko, PIC, kode toko..." 
    ...
    <script>
        ...
        async function loadWinners(page = 1) {
            ...
            try {
                ...
                const response = await fetch(`/pemenang-kehadiran/${currentLokasi}/data?page=${page}&per_page=${itemsPerPage}`);
            ...
            tableBody.innerHTML = paginatedWinners.map((winner, index) => {
                ...
                return `
                    <tr class="hover:bg-red-50 transition-colors ${rowClass}">
                        ...
                        <td class="font-mono text-red-600 font-bold">${highlightText(winner.kode_toko)}</td>
                    </tr>
                `;
            }).join('');
        ...
        async function toggleStatus(pemenangId, newStatus) {
            try {
                const response = await fetch(`/pemenang-kehadiran/${pemenangId}/update-status`, {
                    method: 'POST',
                    headers: {
