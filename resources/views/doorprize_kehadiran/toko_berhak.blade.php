...
<body>
    ...
    <div class="container">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="#" id="exportBtn" onclick="exportExcel(event)"
                   class="px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-700 rounded-lg hover:from-green-700 hover:to-emerald-800 transition-all flex items-center text-white">
    ...
    <script>
        ...
        function exportExcel(event) {
            ...
            const doorprizeId = getDoorprizeId();
            window.location.href = `/doorprize-kehadiran/{{ $lokasi }}/toko-berhak/export?doorprize_id=${doorprizeId}`;
        }
