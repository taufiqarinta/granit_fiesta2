<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="space-x-2">
                <a href="{{ route('masterdoorprizekehadiran.trash') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-sm">
                    Data Nonaktif
                </a>
                <a href="{{ route('masterdoorprizekehadiran.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    Tambah Doorprize Kehadiran
                </a>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-9xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="mb-3">
                        <h3 class="text-base font-semibold">Link Doorprize Kehadiran</h3>
                                    ...
                                    @forelse($uniqueLokasiList as $index => $lokasi)
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="py-1.5 px-2 border-b text-center whitespace-nowrap">
                                                <form action="{{ route('masterdoorprizekehadiran.reset-pemenang', $lokasi->lokasi_event) }}" method="POST" class="inline" id="reset-form-{{ $index }}">
                                                    @csrf
                                                    <button type="button"
                                            ...
                                            <td class="py-1.5 px-2 border-b text-center whitespace-nowrap">
                                                <a href="{{ url('/doorprize-kehadiran/' . $lokasi->lokasi_event) }}"
                                                   target="_blank"
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold">Daftar Master Doorprize Kehadiran Aktif</h3>
                                        ...
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="py-3 px-4 border-b text-sm text-gray-900 text-center whitespace-nowrap">
                                                @foreach($doorprize->lokasi as $lokasi)
                                                    <a href="{{ url('/doorprize-kehadiran/' . $lokasi->lokasi_event . '/' . $doorprize->id) }}"
                                                       target="_blank"
                                                       rel="noopener noreferrer"
                                            ...
                                            <td class="py-3 px-4 border-b text-sm whitespace-nowrap">
                                                <div class="flex justify-center space-x-3">
                                                    <a href="{{ route('masterdoorprizekehadiran.show', $doorprize->id) }}" 
                                                    ...
                                                    <a href="{{ route('masterdoorprizekehadiran.edit', $doorprize->id) }}" 
                                                    ...
                                                    <form action="{{ route('masterdoorprizekehadiran.destroy', $doorprize->id) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" 
                                        ...
                                        <tr>
                                            <td colspan="7" class="py-6 px-4 border-b text-center text-gray-500">
                                                <div class="flex flex-col items-center justify-center">
                                                    ...
                                                    <span class="text-base font-medium text-gray-600">Tidak ada data doorprize kehadiran aktif.</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
    ...
    <script>
        function confirmReset(lokasi, formId) {
            Swal.fire({
                ...
                text: 'Yakin ingin mereset semua pemenang doorprize kehadiran untuk lokasi ' + lokasi + '? Semua data pemenang akan dihapus.',
                icon: 'warning',
